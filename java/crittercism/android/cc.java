...
public final class cc implements cb {
    ...
    private static org.json.JSONArray a(java.io.InputStream r4) {
        /*
    ...
    L_0x0023:
        r0 = move-exception;
        crittercism.android.dx.a();
        goto L_0x0022;
    L_0x0028:
        r0 = move-exception;
        crittercism.android.dx.a();	 Catch:{ all -> 0x0035 }
    ...
    public final JSONArray a() {
        ...
        if (VERSION.SDK_INT < 10) {
            ...
            try {
                ...
                dx.b("Unable to collect logcat data", e);
